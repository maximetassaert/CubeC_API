...
namespace Cube_C___API.Migrations
{
    ...
    [Migration("20240209084830_fix delivered supplier order")]
    partial class fixdeliveredsupplierorder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cube_C___API.Models.SupplierOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cube_C___API.Models.SupplierOrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryProduct", b =>
                {
                    b.HasOne("Cube_C___API.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cube_C___API.Models.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Cube_C___API.Models.Product", b =>
                {
                    b.HasOne("Cube_C___API.Models.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("Cube_C___API.Models.SupplierOrderLine", b =>
                {
                    ...
                    b.HasOne("Cube_C___API.Models.SupplierOrder", "SupplierOrder")
